...
SESSION_START_SECOND_MATE_TMP="${FM_TASK_TMP_ROOT:-/tmp}/fm-$SESSION_START_SECOND_MATE_ID"
SESSION_START_HERDR_SECOND_MATE_ID="fmtest-herdr-${TMP_ROOT##*.}"
SESSION_START_HERDR_SECOND_MATE_TMP="${FM_TASK_TMP_ROOT:-/tmp}/fm-$SESSION_START_HERDR_SECOND_MATE_ID"
...
EOF
  ...
  assert_contains "$out" "$CHARTER_LABEL" "digest silently skipped the absent charter section"
