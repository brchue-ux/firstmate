...
#                       (legacy PR-check migration, stale temp-root scratch
#                       reclamation, secondmate convergence, secondmate
#                       liveness, pending remote handoff retry, X-mode artifact
#                       writes, fleet sync) also run only when locked; the four
#                       network sweeps run in the deferred stage rather than
