...
The same deferred network stage runs bootstrap's guarded secondmate sync for recorded homes, then propagates declared inherited local material into each validated home, including a home whose agent the liveness sweep left down.
