...
The verified adapter knowledge - busy signatures, interrupt and exit commands, skill-invocation syntax, and per-harness quirks - lives in one file per harness under [`.agents/skills/harness-adapters/adapters/`](../.agents/skills/harness-adapters/adapters), indexed by [`.agents/skills/harness-adapters/SKILL.md`](../.agents/skills/harness-adapters/SKILL.md).
