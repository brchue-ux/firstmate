...
That bounded recheck names a confirmed-dead crew as such rather than as an ordinary continuing external wait, including when the classification is re-derived inside the shorter recheck-throttle window.
